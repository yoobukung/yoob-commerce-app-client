...
const Menu = () => {
  return (
    <header className="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm main-nav">
      ...
      &nbsp; &nbsp;
      <SearchProduct />
      <Link className="p-2 text-dark" to="/doc">
        Doc
      </Link>
      <MenuAuthenticate />
      <CartItems />
